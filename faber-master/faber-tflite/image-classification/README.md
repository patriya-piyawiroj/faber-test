# [Faber Labs] TensorFLow Lite Food Classification iOS starter code
...
a finetuned MobileNet model. The application is intended to be run on device and not a simulator.
